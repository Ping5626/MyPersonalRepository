...
public class HttpClientUtils extends HttpUtils {
     ...
     */
    @Override
    public String get(String url, List<HttpHeaderEnums> headers) throws Exception {
     ...
     */
    @Override
    public String post(String url, String param, List<HttpHeaderEnums> headers) throws Exception {
     ...
     */
    @Override
    public String postByFile(String url, MultipartFile file, String fileParamName, Map<String, String> params, List<HttpHeaderEnums> headers) throws Exception {
        HttpPost httpPost = new HttpPost(url);
        httpPost.setConfig(getRequestConfig());
        if (headers != null && headers.size() > 0) {
            headers.forEach(header -> {
