...
public class POITest {
    ...
    public void parseSQL() {
        String sql = "CREATE TABLE `asset_code` (\n" +
                "  `id` int NOT NULL AUTO_INCREMENT,\n" +
                "  `code_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '唯一主键',\n" +
                "  `code_type` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '码表类型',\n" +
                "  `code_text` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '码表内容',\n" +
                "  `code_value` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '码值',\n" +
                "  `valid_flag` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '是否删除/1有效0删除',\n" +
                "  PRIMARY KEY (`id`),\n" +
                "  UNIQUE KEY `index_id` (`code_id`)\n" +
                ") ENGINE=InnoDB AUTO_INCREMENT=176 DEFAULT CHARSET=utf8 COMMENT='不良资产估值码表';";
