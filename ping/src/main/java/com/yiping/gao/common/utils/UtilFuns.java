...
public class UtilFuns {
    ...
    /**
     * 功能：返回分割后的数组 输入参数：String str 设置返回系统时间样式 输入参数：String SplitFlag 设置分割字符
     * 输出参数：string[] 返回分割后的数组 作者：宋江 时间：2003-9-7 用法： String s[] = SplitStr(
     * "asd asd we sd"," "); for (int
    ...
    /**
     * 功能：将数组合并为一个字符串 输入参数：String[] aStr 要合并数组 输入参数：String SplitFlag 设置分割字符
     * 输出参数：String 要合并数组 作者：宋江 时间：2004-1-9
     */
    ...
    /**
     * JoinStr 功能：将数组合并为一个字符串 输入参数：String sPrefix 数组元素加的前缀 输入参数：String sSuffix
     * 数组元素加的后缀 输入参数：String SplitFlag 设置分割字符 输出参数：String 合并后的字符串 作者：宋江
     * 时间：2005-3-17
     */
    ...
    /**
     * 功能：返回系统时间 输入参数：int style 设置返回系统时间样式 输出参数：string 返回系统时间样式 作者：宋江
     * 时间：2003-6-24 存 在问题：中文乱码，但JSP中显示正常。
     */
     ...
     * @param <T>
     */
    public static <T> int existElements(String s, ArrayList<T> aList) {
        try {
     ...
     * @param <T>
     */
    public static <T> boolean existElements(Object o, Set<T> set) {
     ...
     * @param <T>
     */
    public static <T> int IsIndexOfElements(String s, ArrayList<T> aList) {
        try {
            String s1 = "";
            for (int i = 0; i < aList.size(); i++) {
     ...
     */
    public <T> String[] ArrayListToString(ArrayList<T> aList) {
    ...
    public static <T> void formatArrayList(ArrayList<T> al) {
    ...
    /**
     * 功能：选定在下拉列表框中与查找到数据,相符的那一项内容
     * 输入参数：String CurrentValue 查找出的数据库中的数据
     * 输入参数：String[] content 需要输出的所有下拉列表框的内容
     * 输出参数：返回下拉列表
     ...
     * 功能：选定在下拉列表框中与查找到数据,相符的那一项内容
     * 输入参数：String CurrentValue 查找出的数据库中的数据
     * 输入参数：String[] values 需要输出的所有下拉列表框的内容所对应的值
     * 输入参数：String[] content 需要输出的所有下拉列表框的内容
     * 输出参数：返回下拉列表
     * 修改：宋江
     * 修改时间：2003-9-4
     * 注意事项：values和content数组个数必须相同.适合从数据库中取值
     * <% String[] aContextOPERATE_TYPE = {"定检","轮换","抽检"}; out.print(optionFuns.ComboList("",aContextOPERATE_TYPE, aContextOPERATE_TYPE)); %>
     */
    ...
    /**
     * 功能：将字符串转换为Timestamp 。
     * 输入参数：String timestampStr 设置要转换的字符串
     * 输入参数：String pattern 要转换的format
    ...
    // 转换中文 格式必须为："yyyy-MM-dd HH:mm:ss"的一部分
	 ...
	 *  switch (n_day) {
	 * 		case 0:{ strDate = strDate + "星期日" }break; 
	 * 		case 1:{ strDate = strDate + "星期一" }break; 
	 * 		case 2:{ strDate = strDate + "星期二" }break; 
	 * 		case 3:{ strDate = strDate + "星期三" }break; 
	 * 		case 4:{ strDate = strDate + "星期四" }break; 
	 * 		case 5:{ strDate = strDate + "星期五" }break; 
	 * 		case 6:{ strDate = strDate + "星期六" }break; 
	 * 		case 7:{ strDate = strDate + "星期日" }break; 
	 * 	}
